...
function Blit(srcX, srcY, copyW, copyH, destX, destY) {
  ...
  this.draw = function () {
    if (this.blitTimer == this.lifespan) {
      ...
      hiddenCanvasContext.drawImage(canvas, this.srcX, this.srcY, this.copyW, this.copyH, this.destX, this.destY, this.copyW, this.copyH);
    }
  };
}
...
function slideScreen() {
  ...
  canvasContext.drawImage(canvas, 0, 0, canvas.width, canvas.height, slidex, slidey, canvas.width, canvas.height);
...
Sound.queue = [["music/", "spacepool-slow.wav"], ["music/", "daeve-1.wav"], ["music/", "daeve-2.wav"], ["music/", "daeve-3.wav"], ["music/", "daeve-4.wav"]];
