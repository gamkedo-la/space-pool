...
function loadImages() {
  var imageList = [{ varName: shipPic, theFile: "player1.png" }, { varName: titlePic, theFile: "drift_bravely.png" }];
...
var GLITCH_THE_SCANLINE_OVERLAY = false;;
var SCROLL_THE_SCANLINE_OVERLAY = !DEBUG;
...
window.onload = function () {
  ...
  if (GLITCH_THE_SCANLINE_OVERLAY) glitchScanlineOverlay();
  if (SCROLL_THE_SCANLINE_OVERLAY) scrollScanlineOverlay();
};
...
function Ship() {
  ...
  this.move = function (colliders) {
    ...
    if (!this.keyHeld_Gas && shipCanMove) {
      if (Sound && Sound.cache['sfx_ship_thrust']) Sound.volume('sfx_ship_thrust', 0);
    }
    ...
    if (this.keyHeld_Gas && shipCanMove == true) {
      ...
      if (Sound && Sound.cache['sfx_ship_thrust']) {
        ...
        if (Sound.cache['sfx_ship_thrust'].currentTime < 0.0001 || Sound.cache['sfx_ship_thrust'].currentTime >= Sound.cache['sfx_ship_thrust'].duration - 0.0001 || Sound.cache['sfx_ship_thrust'].ended) {
...
Sound.queue = [["music/", "spacepool-low-volume.webm"], ["music/", "tape-1.webm"], ["music/", "tape-2.webm"], ["music/", "tape-3.webm"], ["music/", "tape-4.webm"], ["music/", "mark-1.webm"], ["music/", "mark-2.webm"], ["music/", "mark-3.webm"], ["music/", "mark-4.webm"], ["music/", "mirror-1.webm"], ["music/", "mirror-2.webm"], ["music/", "mirror-3.webm"], ["music/", "mirror-4.webm"], ["music/", "drift.webm"], ["music/", "sfx_asteroid_explo.webm"], ["music/", "sfx_laser.webm"], ["music/", "sfx_ship_thrust.webm"]];
